...
router.post("/submit", async (req, res) => {
  try {
    ...
    const text = [
      ...
      "",
      `Total Shirt Quantity: ${totalQuantity ?? ""}`,
      "",
      `Title: ${yesNo(backTitle)}`,
      `Name: ${yesNo(backName)}`,
      `School/Team/Organization: ${yesNo(backOrganization)}`,
      `School/Team/Organization Name: ${backOrganizationName || ""}`,
