...
export default function TShirtDesigner() {
  ...
  const addCustomImage = () => {
    if (canvas) {
      // Create a native image element
      const el = new Image();
      el.crossOrigin = "anonymous"; // useful for remote URLs
      el.src =
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ0Kw-jUpRayMlbiZlEwk4BltQ7qN6IjZ_h2Q&s";
  ...
  return (
    <>
      <div className="toolbar">
        ...
        <button onClick={addCustomImage}>Add an img</button>
      </div>
